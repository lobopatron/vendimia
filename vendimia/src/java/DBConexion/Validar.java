...
public class Validar {
    ...
    public String configuracion() {
        String conf = "", tasa = "", enganche = "", plazo = "", boton = "", id = "";

        try {
            rs = s.configuracion();
            while (rs.next()) {
                if (!rs.getString("tasa_fin").isEmpty() || !rs.getString("por_enganche").isEmpty() || !rs.getString("plazo").isEmpty()) {
                    id = rs.getString("id");
            ...
            conf = conf + "<div class=\"renglon\">\n"
                    ...
                    + "                        </div>\n"
                    + "                        <div class=\"label_input\">\n"
                    + "                            <input type=\"text\" id=\"busclien\" name=\"idconf\" value=\"" + id + "\" class=\"input\" style=\"display:none;\" required>\n"
                    + "                            <input type=\"text\" id=\"busclien\" name=\"tasaFin\" value=\"" + tasa + "\" class=\"input\" required>\n"
                    + "                        </div>\n"
                    + "                    </div>\n"
                    + "                    <div class=\"renglon\">\n"
                    + "                        <div class=\"label\">\n"
                    ...
                    + "                        </div>\n"
                    + "                        <div class=\"label_input\">\n"
                    + "                            <input type=\"text\" id=\"busclien\" class=\"input\" value=\"" + enganche + "\" name=\"enganche\" required>\n"
                    + "                        </div>\n"
                    + "                    </div>\n"
                    + "                    <div class=\"renglon\">\n"
                    + "                        <div class=\"label\">\n"
                    ...
                    + "                        </div>\n"
                    + "                        <div class=\"label_input\">\n"
                    + "                            <input type=\"text\" id=\"busclien\" class=\"input\" value=\"" + plazo + "\" name=\"pazoMax\" required>\n"
                    + "                        </div>\n"
                    + "                    </div>"
                    + "                    <div class=\"renglon\">\n"
                    + "                        <div class=\"label\">\n"
